...
const TermsAndConditions: NextPage<PageProps> = (props: InferGetStaticPropsType<typeof getStaticProps>) => {
  ...
  return Layout(
    <div className="m-auto p-3">
      ...
      <p>
        ...
        presta su consentimiento a los mismos y acepta estar vinculado por estos Términos y Condiciones, la Política de
        Privacidad y la Política de Cookies, tal y como puedan ser actualizados en cada momento. Por favor lea estos
        Términos y Condiciones antes de usar la Web.
      </p>
      ...
      <p>
        ...
        de la Convención de las Naciones Unidas sobre la Compraventa) y cualquier disputa entre el Usuario y la Compañía
        estará sujeta a los Juzgados y Tribunales del domicilio del Usuario.
      </p>
    </div>
  );
};
