...
const locales: LocaleObject = {
  ...
  postre: "Postres",
  bebida: "Bebidas",
  botella: "Botellas 70 cl (+18)",
  cocktail: "Cocktails con Ron Barceló Organic (+18)",
  ...
  escogePlato: "Escoge Plato",
  ternera: "Ternera",
  pollo: "Pollo",
  tofu: "Tofu",
  extraVerdura: "Sólo Verdura",
  pan: "Pan",
  pasta: "Pasta",
  arroz: "Arroz",
  sinBase: "Sin Base",
  ...
  name: "Nombre",
  macarronesBolonyesa: "Macarrones Boloñesa",
  arrosMuntanya: "Arroz de Montaña",
  paellaVegana: "Paella Vegana",
  tacosTernera: "Tacos de Ternera",
  ...
  estadoDeTuPedido: {
    title: "La Gallina Ponedora | Tus Pedidos",
    description: "Ve tus pedidos",
